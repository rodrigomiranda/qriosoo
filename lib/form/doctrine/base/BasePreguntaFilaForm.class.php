...
/**
 * PreguntaFila form base class.
 *
 * @method PreguntaFila getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePreguntaFilaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pregunta_fila[%s]');
